...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2340
         ItemData        =   "frmMain.frx":7490
         Left            =   405
         List            =   "frmMain.frx":7492
         TabIndex        =   4
         Top             =   960
         Width           =   2655
      End
   ...
   Begin VB.PictureBox picWhosOnline 
      ...
      Begin VB.ListBox lstOnline 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMain.frx":87F81F
         Left            =   410
         List            =   "frmMain.frx":87F821
         TabIndex        =   12
         Top             =   960
         Width           =   2630
      End
   ...
   Begin VB.PictureBox picFriend 
      ...
      Begin VB.ListBox lstFriend 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMain.frx":884FE9
         Left            =   375
         List            =   "frmMain.frx":884FEB
         TabIndex        =   119
         Top             =   960
         Width           =   2700
      End
...
Private Sub picInv_MouseDown(Index As Integer, Button As Integer, Shift As Integer, x As Single, y As Single)
    Inventory = Index + 1
    frmMain.SelectedItem.Top = frmMain.picInv(Inventory - 1).Top - 1
    frmMain.SelectedItem.Left = frmMain.picInv(Inventory - 1).Left - 1
...
Dim ii As Long
    ...
    ElseIf KeyCode = vbKeyF12 Then
        ScreenShot.Picture = CaptureArea(frmMain, picScreen.Left, picScreen.Top, picScreen.Width, picScreen.Height)
        I = 0
        ii = 0
        If LCase(Dir(App.Path & "\Screenshots", vbDirectory)) <> "screenshots" Then
            Call MkDir(App.Path & "\Screenshots")
...
Private Sub picPlayerSpells_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.picPlayerSpells, Button, Shift, x, y)
End Sub
...
Private Sub picStatus_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.picStatus, Button, Shift, x, y)
End Sub
...
Private Sub picWhosOnline_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.picWhosOnline, Button, Shift, x, y)
End Sub
...
Private Sub picInv3_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.picInv3, Button, Shift, x, y)
End Sub
...
Private Sub picFriend_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.picFriend, Button, Shift, x, y)
End Sub
...
Private Sub itmDesc_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.itmDesc, Button, Shift, x, y)
End Sub
...
Private Sub picGuildAdmin_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    Call MovePicture(frmMain.picGuildAdmin, Button, Shift, x, y)
End Sub
...
If Inventory <= 0 Then Exit Sub
    ...
    If GetPlayerInvItemNum(MyIndex, InvNum) > 0 And GetPlayerInvItemNum(MyIndex, InvNum) <= MAX_ITEMS Then
        If Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_CURRENCY Then
            GoldAmount = InputBox("How much " & Trim$(Item(GetPlayerInvItemNum(MyIndex, InvNum)).Name) & "(" & GetPlayerInvItemValue(MyIndex, InvNum) & ") would you like to drop?", "Drop " & Trim$(Item(GetPlayerInvItemNum(MyIndex, InvNum)).Name), 0, frmMain.Left, frmMain.Top)
