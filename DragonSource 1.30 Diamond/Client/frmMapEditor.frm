...
Private Sub cmdEyeDropper_Click()
    'If frmMapEditor.MousePointer = 2 Or frmMain.MousePointer = 2 Then
...
Private Sub cmdprops_Click()
    frmMapProperties.Show vbModeless, frmMain
...
Private Sub optAttributes_Click()
    ...
    frmMain.shpSelect.Width = 32
    frmMain.shpSelect.Height = 32
End Sub
...
Private Sub picBackSelect_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
   If Button = 1 Then
        ...
        Else
            ...
            End If
        End If
        frmMain.shpSelect.Width = shpSelected.Width
        frmMain.shpSelect.Height = shpSelected.Height
    End If
