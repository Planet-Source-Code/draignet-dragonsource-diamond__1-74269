...
Begin VB.Form frmMapProperties 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "Spawn(14)"
      Tab(1).Control(1)=   "Spawn(13)"
      Tab(1).Control(2)=   "Spawn(12)"
      Tab(1).Control(3)=   "Spawn(11)"
      Tab(1).Control(4)=   "Spawn(10)"
      Tab(1).Control(5)=   "Spawn(9)"
      Tab(1).Control(6)=   "Spawn(8)"
      Tab(1).Control(7)=   "Spawn(7)"
      Tab(1).Control(8)=   "Spawn(6)"
      Tab(1).Control(9)=   "Spawn(5)"
      Tab(1).Control(10)=   "Spawn(4)"
      Tab(1).Control(11)=   "Spawn(3)"
      Tab(1).Control(12)=   "Spawn(2)"
      Tab(1).Control(13)=   "Spawn(1)"
      Tab(1).Control(14)=   "Spawn(0)"
      Tab(1).Control(15)=   "Copy(9)"
      Tab(1).Control(16)=   "Copy(13)"
      Tab(1).Control(17)=   "Copy(12)"
      Tab(1).Control(18)=   "Copy(11)"
      Tab(1).Control(19)=   "Copy(10)"
      Tab(1).Control(20)=   "Copy(8)"
      Tab(1).Control(21)=   "Copy(7)"
      Tab(1).Control(22)=   "Copy(6)"
      Tab(1).Control(23)=   "Copy(5)"
      Tab(1).Control(24)=   "Copy(4)"
      Tab(1).Control(25)=   "Copy(3)"
      Tab(1).Control(26)=   "Copy(2)"
      Tab(1).Control(27)=   "Copy(1)"
      Tab(1).Control(28)=   "Copy(0)"
      Tab(1).Control(29)=   "Command1"
      Tab(1).Control(30)=   "cmbNpc(0)"
      Tab(1).Control(31)=   "cmbNpc(1)"
      Tab(1).Control(32)=   "cmbNpc(2)"
      Tab(1).Control(33)=   "cmbNpc(3)"
      Tab(1).Control(34)=   "cmbNpc(4)"
      Tab(1).Control(35)=   "cmbNpc(5)"
      Tab(1).Control(36)=   "cmbNpc(6)"
      Tab(1).Control(37)=   "cmbNpc(7)"
      Tab(1).Control(38)=   "cmbNpc(8)"
      Tab(1).Control(39)=   "cmbNpc(9)"
      Tab(1).Control(40)=   "cmbNpc(10)"
      Tab(1).Control(41)=   "cmbNpc(11)"
      Tab(1).Control(42)=   "cmbNpc(12)"
      Tab(1).Control(43)=   "cmbNpc(13)"
      Tab(1).Control(44)=   "cmbNpc(14)"
      Tab(1).Control(45)=   "Num(14)"
      Tab(1).Control(46)=   "Num(13)"
      Tab(1).Control(47)=   "Num(12)"
      Tab(1).Control(48)=   "Num(11)"
      Tab(1).Control(49)=   "Num(10)"
      Tab(1).Control(50)=   "Num(9)"
      Tab(1).Control(51)=   "Num(8)"
      Tab(1).Control(52)=   "Num(7)"
      Tab(1).Control(53)=   "Num(6)"
      Tab(1).Control(54)=   "Num(5)"
      Tab(1).Control(55)=   "Num(4)"
      Tab(1).Control(56)=   "Num(3)"
      Tab(1).Control(57)=   "Num(2)"
      Tab(1).Control(58)=   "Num(1)"
      Tab(1).Control(59)=   "Num(0)"
