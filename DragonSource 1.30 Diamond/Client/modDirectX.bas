...
Sub InitDirectSM()
    ...
    Call Ds.SetCooperativeLevel(frmMain.hWnd, DSSCL_NORMAL)
...
Dim I As Long
    ...
    If GameWeather = WEATHER_RAINING Or GameWeather = WEATHER_THUNDER Then
        For I = 1 To MAX_RAINDROPS
            If DropRain(I).Randomized = False Then
                If frmMain.tmrRainDrop.Enabled = False Then
                    BLT_RAIN_DROPS = 1
                    frmMain.tmrRainDrop.Enabled = True
                    If frmMain.tmrRainDrop.Tag = vbNullString Then
                        frmMain.tmrRainDrop.Interval = 200
                        frmMain.tmrRainDrop.Tag = "123"
                    End If
                End If
            End If
        Next I
    ElseIf GameWeather = WEATHER_SNOWING Then
        For I = 1 To MAX_RAINDROPS
            If DropSnow(I).Randomized = False Then
                If frmMain.tmrSnowDrop.Enabled = False Then
                    BLT_SNOW_DROPS = 1
                    frmMain.tmrSnowDrop.Enabled = True
                    If frmMain.tmrSnowDrop.Tag = vbNullString Then
                        frmMain.tmrSnowDrop.Interval = 200
                        frmMain.tmrSnowDrop.Tag = "123"
                    End If
                End If
            End If
        Next I
    Else
        ...
        End If
        frmMain.tmrRainDrop.Tag = vbNullString
    End If
