...
Begin VB.Form frmSpellEditor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(14)=   "scrlSound"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "scrlVitalMod"
      ...
      Tab(0).Control(19)=   "scrlRange"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "scrlSpellAnim"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "scrlSpellTime"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "scrlSpellDone"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "picSpell"
      ...
      Begin VB.Frame info 
         ...
         Begin VB.ComboBox cmbClassReq 
            ...
            EndProperty
            Height          =   285
            ItemData        =   "frmSpellEditor.frx":1D79
            Left            =   120
            List            =   "frmSpellEditor.frx":1D7B
            Style           =   2  'Dropdown List
            TabIndex        =   3
            Top             =   1080
            Width           =   4905
