...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2340
         ItemData        =   "frmMirage.frx":5D50
         Left            =   405
         List            =   "frmMirage.frx":5D52
         TabIndex        =   4
         Top             =   960
         Width           =   2655
      End
   ...
   Begin VB.PictureBox picWhosOnline 
      ...
      Begin VB.ListBox lstOnline 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMirage.frx":87E0DF
         Left            =   410
         List            =   "frmMirage.frx":87E0E1
         TabIndex        =   12
         Top             =   960
         Width           =   2630
      End
   ...
   Begin VB.PictureBox picFriend 
      ...
      Begin VB.ListBox lstFriend 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMirage.frx":8838A9
         Left            =   375
         List            =   "frmMirage.frx":8838AB
         TabIndex        =   119
         Top             =   960
         Width           =   2700
      End
